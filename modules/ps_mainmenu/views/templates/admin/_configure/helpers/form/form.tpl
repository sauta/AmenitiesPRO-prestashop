...
{block name="input"}
    {if $input.type == 'link_choice'}
	    <div class="row">
	    	<div class="col-lg-1">
	    		<h4 style="margin-top:5px;">{l s='Cambiar de posición' d='Modules.Mainmenu.Admin'}</h4>
	    	...
	    	<div class="col-lg-4">
	    		<h4 style="margin-top:5px;">{l s='Elementos seleccionados' d='Modules.Mainmenu.Admin'}</h4>
	    		{$selected_links}
	    	</div>
	    	<div class="col-lg-4">
	    		<h4 style="margin-top:5px;">{l s='Elementos disponibles' d='Modules.Mainmenu.Admin'}</h4>
	    		{$choices}
	    	</div>
	    ...
	    <div class="row">
	    	...
	    	<div class="col-lg-4"><a href="#" id="removeItem" class="btn btn-default"><i class="icon-arrow-right"></i> {l s='Quitar' d='Modules.Mainmenu.Admin'}</a></div>
		<div class="col-lg-4"><a href="#" id="addItem" class="btn btn-default"><i class="icon-arrow-left"></i> {l s='Agregar' d='Admin.Actions'}</a></div>
	    </div>
	{else}
		{$smarty.block.parent}
    {/if}
