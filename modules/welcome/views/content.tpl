...
<div class="onboarding-advancement" style="display: none">
  ...
  <button class="btn btn-primary onboarding-button-next">{l s='Continuar' d='Modules.Welcome.Admin'}</button>
  <a class="onboarding-button-shut-down">{l s='Saltar este tutorial' d='Modules.Welcome.Admin'}</a>
</div>
