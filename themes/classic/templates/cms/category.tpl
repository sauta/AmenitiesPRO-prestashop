...
{block name='page_content'}
  {block name='cms_sub_categories'}
    {if $sub_categories}
      <p>{l s='Lista de subcategorias en %name%:' d='Shop.Theme.Global' sprintf=['%name%' => $cms_category.name]}</p>
      <ul>
  ...
  {block name='cms_sub_pages'}
    {if $cms_pages}
      <p>{l s='Lista de paginas en %category_name%:' d='Shop.Theme.Global' sprintf=['%category_name%' => $cms_category.name]}</p>
      <ul>
